  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        {/* MRR Trend */}
        <Card className="border-[#131B35] bg-[#0A0F1E] lg:col-span-2">
          <CardHeader>
        ...
        <Card className="border-[#131B35] bg-[#0A0F1E]">
          ...
          <CardContent>
            <div className="grid grid-cols-3 gap-4">
              <div className="rounded-lg bg-[#131B35] p-4 text-center">
                <Bot className="mx-auto mb-2 h-6 w-6 text-[#1D4ED8]" />
              ...
              <div className="rounded-lg bg-[#131B35] p-4 text-center">
                <Zap className="mx-auto mb-2 h-6 w-6 text-[#1D4ED8]" />
                <p className="text-2xl font-bold text-white">
              ...
              <div className="rounded-lg bg-[#131B35] p-4 text-center">
                <Coins className="mx-auto mb-2 h-6 w-6 text-[#1D4ED8]" />
                <p className="text-2xl font-bold text-white">
          ...
          <CardContent>
            <div className="space-y-2">
              {data.recent_webhooks.map((wh) => (
                <div
                  key={wh.id}
                  className="flex items-center justify-between rounded-lg bg-[#131B35] px-3 py-2"
                >
