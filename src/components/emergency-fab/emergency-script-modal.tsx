        ...
        <>
          ...
          <motion.div
            ...
            className="fixed bottom-0 left-0 right-0 z-[61] max-h-[85vh] flex flex-col
                       rounded-t-2xl bg-[#0A0F1E] border-t border-white/10 shadow-2xl
          ...
          >
              ...
              <div className="flex-1 min-w-0 pr-4">
                ...
                {script.category && (
                  <span
                    ...
                    style={{
                      color: script.category.color || '#1D4ED8',
                      borderColor: `${script.category.color || '#1D4ED8'}40`,
                      backgroundColor: `${script.category.color || '#1D4ED8'}15`,
                    }}
                  >
            ...
            <div className="flex-1 overflow-y-auto px-5 py-4 scrollbar-thin">
              ...
              {script.context_description && (
                <div className="mb-4 p-3 rounded-lg bg-[#3B82F6]/20 border border-[#3B82F6]/30">
              ...
              {/* Script content */}
              <div className="p-4 rounded-xl bg-[#131B35] border border-white/5">
